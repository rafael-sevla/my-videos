class VideosController < ApplicationController
  ...
  # POST /comments.json
  def add_comment
    logger.debug("asdasdasdasdasfasdjivhsdifgneoivgnprdtngpiudnvguitngiunero")
    @comment = Comment.new(comment_params)

    respond_to do |format|
      if @comment.save
        format.html { redirect_to action: "show", id: comment_params.video_id, notice: 'Comment was successfully created.' }
